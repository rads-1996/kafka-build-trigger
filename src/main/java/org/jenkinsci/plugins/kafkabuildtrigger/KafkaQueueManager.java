...
public final class KafkaQueueManager {

    /**
     * Intance holder class for {@link KafkaQueueManager}.
     *
     * @author Radhika Gupta
     */
    private static class InstanceHolder {
        private static final KafkaQueueManager INSTANCE = new KafkaQueueManager();
    }

    private static final long TIMEOUT_CLOSE = 300000;
    private static final Logger LOGGER = LoggerFactory.getLogger(KafkaQueueManager.class);
     ...
     * @return the instance.
     */
    public static KafkaQueueManager getInstance() {
    ...
    public void update() {
        ...
        // String brokers = "broker:9092"; //conf.getBrokers();
        //String topicName = "build_trigger"; //conf.getTopic();
        ...
        try {
            ...
            if (enableConsumer) {
                if (kafkaConnection == null) {
                    kafkaConnection = new KafkaConsumerHandler(brokers, topicName);
                    try {
                    ...
                    kafkaConnection.updateConf(brokers, topicName);
                }
            }
